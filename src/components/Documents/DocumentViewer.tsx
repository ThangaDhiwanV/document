            ...
            {activeTab === 'content' && (
              <div>
                ...
                {document.data && Object.keys(document.data).length > 0 ? (
                  ...
                  <p className="text-gray-500 italic">No content data available</p>
                )}
              </div>
            )}
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      <tr>
                        <td className="px-4 py-2 text-sm text-gray-900">Assay (%)</td>
                        <td className="px-4 py-2 text-sm text-gray-600">98.0 - 102.0</td>
                        <td className="px-4 py-2 text-sm text-gray-900">99.8</td>
                      ...
                      <tr>
                        <td className="px-4 py-2 text-sm text-gray-900">Related Substances (%)</td>
                        <td className="px-4 py-2 text-sm text-gray-600">≤ 2.0</td>
                        <td className="px-4 py-2 text-sm text-gray-900">0.3</td>
                        <td className="px-4 py-2 text-sm">
                          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                            Pass
                          </span>
                      ...
                      <tr>
                        <td className="px-4 py-2 text-sm text-gray-900">Water Content (%)</td>
                        <td className="px-4 py-2 text-sm text-gray-600">≤ 0.5</td>
                        <td className="px-4 py-2 text-sm text-gray-900">0.2</td>
                        <td className="px-4 py-2 text-sm">
                          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                            Pass
                          </span>
