...
const FormBuilder: React.FC = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 overflow-hidden">
      {/* Notification */}
      {notification && (
        <div className={`fixed top-20 right-4 px-6 py-3 rounded-lg shadow-lg z-50 flex items-center space-x-2 ${notification.type === 'success' ? 'bg-green-600 text-white' : 'bg-red-600 text-white'
          }`}>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <input
              ...
              className={`text-xl font-bold bg-transparent border-none focus:outline-none focus:ring-2 focus:ring-blue-500 rounded px-2 ${modeInfo.color.includes('green') ? 'text-green-700' :
            ...
            <select
              ...
              className={`px-3 py-1 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-blue-500 ${isEditTemplate || isLocked ? 'bg-gray-100 cursor-not-allowed' : ''
                }`}
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-1 bg-gray-100 rounded-md p-0.5">
              <button
                ...
                className={`p-1.5 rounded transition-colors ${viewMode === 'canvas' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:text-gray-900'
                  }`}
                title="Canvas View"
              >
              ...
              <button
                ...
                className={`p-1.5 rounded transition-colors ${viewMode === 'grid' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:text-gray-900'
                  }`}
                title="Grid View"
              >
              ...
              <button
                ...
                className={`p-1.5 rounded transition-colors ${viewMode === 'list' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:text-gray-900'
                  }`}
                title="List View"
              >
            ...
            {selectedField && (
              <div className="flex items-center space-x-2">
                <button
                  onClick={toggleDock}
                  className={`p-2 rounded-lg transition-colors ${isPanelDocked ? 'bg-blue-100 text-blue-600' : 'text-gray-600 hover:bg-gray-100'
                    }`}
      ...
      <div className="flex-1 flex pt-16 overflow-hidden">
              ...
              <div className="mt-6">
                ...
                <div className="space-y-1 max-h-40 overflow-y-auto">
                  {fields.map((field) => (
                    <div
                      key={field.id}
                      className={`group p-2 rounded-md text-xs cursor-pointer transition-colors ${selectedField?.id === field.id
        ...
        {/* Form Canvas */}
        <div
          className={`flex-1 flex flex-col overflow-hidden transition-all duration-300 ${isPanelDocked && isPanelOpen ? 'mr-80' : ''
            }`}
        >
          ...
          <>
            ...
            <div
              className={`${isPanelDocked
                ...
                } transform transition-transform duration-300 ease-in-out ${isPanelOpen ? 'translate-x-0' : 'translate-x-full'
                } flex flex-col h-full`}
            >
              <div className={`flex items-center justify-between p-4 border-b border-gray-200 flex-shrink-0 ${isPanelDocked ? 'bg-gray-50' : 'bg-white'
                }`}>
                <div className="flex items-center space-x-2">
